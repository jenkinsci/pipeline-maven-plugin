...
public class GitSampleRepoRuleUtils {
     ...
     */
    public static void addFilesAndCommit(@NonNull Path rootFolder, @NonNull GitSampleRepoRule sampleDVCSRepoRule)
            throws IOException {
        ...
        if (sampleDVCSRepoRule.sampleRepo == null)
            throw new IllegalStateException(
                    "SampleDVCSRepoRule has not been initialized", new NullPointerException("sampleRepo is null"));
